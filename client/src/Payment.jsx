...
function Payment() {
  ...
  return (
    ...
    <a href="#" class="text-2xl font-bold text-[#17403C] ">Glaze and Grace</a>
  ...
  <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    <div class="px-4 pt-8">
      ...
      <p class="text-[#17403C] ">Check your items. And select a suitable shipping method.</p>
      <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
        ...
        <div class="flex flex-col rounded-lg bg-white sm:flex-row">
          ...
          <div class="flex w-full flex-col px-4 py-4">
            ...
            <p class="mt-auto text-lg font-bold">{product.price}</p>
          </div>
        </div>
      </div>
